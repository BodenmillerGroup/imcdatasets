...
* Format the single cell data into a [SingleCellExperiment](https://bioconductor.org/packages/SingleCellExperiment) 
object.
...
**objects must be formatted as described in the `Dataset format` section below.**
