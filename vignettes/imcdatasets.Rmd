...
imaging mass cytometry (IMC) @giesen2014imc datasets.  
...
Please refer to the `r Biocpkg("SingleCellExperiment")` and 
`r Biocpkg("cytomapper")` documentation for further information on how to work
with `SingleCellExperiment` and `CytoImageList` objects.
