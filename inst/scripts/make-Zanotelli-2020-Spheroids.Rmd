...
# Output directory
dataset_dir <- file.path(".", "Zanotelli_2020_Spheroids")
...
For consistency with other datasets, we define `cell_id` as {`image_number` `_` `cell_number`}.
...
panel[metal %in% barcoding_channels, `:=` (short_name = paste0("BC_", metal),
                                           antibody_clone = NA)]
panel[metal == "Te125", `:=` (full_name = "Telox2 probe", antibody_clone = NA)]
panel[metal == "La139", `:=` (full_name = "methylated-Histone H3 [K27]",
                              short_name = "me_H3")]
panel[metal == "Pr141", `:=` (full_name = "Histone H3", short_name = "H3")]
panel[metal == "Nd142", `:=` (full_name = "Epidermal growth factor receptor")]
panel[metal == "Nd143", `:=` (full_name = "phospho-FAK [Y397]",
                              short_name = "p_FAK")]
panel[metal == "Nd144", `:=` (full_name = "phospho-MEK1/2 [S217/S221]",
                              short_name = "p_MEK1_2")]
panel[metal == "Nd145", `:=` (full_name = "phospho-MAPKAPK2 [T334]",
                              short_name = "p_MAPKAPK2")]
panel[metal == "Nd146", `:=` (full_name = "phospho-p70S6K [T389]",
                              short_name = "p_p70S6K")]
panel[metal == "Sm147", `:=` (full_name = "phospho-Aurora kinase B [T232]",
                              short_name = "p_AURKB")]
panel[metal == "Nd148", `:=` (full_name = "phospho-STAT1 [S727]",
                              short_name = "p_STAT1")]
panel[metal == "Sm149", `:=` (full_name = "phospho-p53 [S15]",
                              short_name = "p_p53")]
panel[metal == "Eu151", `:=` (full_name = "phospho-EGFR [Tyr1173]",
                              short_name = "p_EGFR")]
panel[metal == "Sm152", `:=` (full_name = "phospho-AMPK alpha [T172]",
                              short_name = "p_AMPKa")]
panel[metal == "Eu153", `:=` (full_name = "phospho-Histone H3 [S28]",
                              short_name = "p_H3")]
panel[metal == "Sm154", `:=` (full_name = "phospho-ERK1/2 [T202/Y204]",
                              short_name = "p_ERK1_2")]
panel[metal == "Gd155", `:=` (full_name = "phospho-HER2 [Y1196]",
                              short_name = "p_HER2")]
panel[metal == "Gd156", `:=` (full_name = "phospho-p38 [T180/Y182]",
                              short_name = "p_p38")]
panel[metal == "Gd158", `:=` (full_name = "phospho-GSK3 [S9]",
                              short_name = "p_GSK3")]
panel[metal == "Gd160", `:=` (short_name = "BIRC5")]
panel[metal == "Dy161", `:=` (full_name = "Cyclin B1",
                              short_name = "CCNB1")]
panel[metal == "Dy162", `:=` (short_name = "VIM")]
panel[metal == "Dy163", `:=` (full_name = "phospho-AKT [S473]",
                              short_name = "p_AKT")]
panel[metal == "Ho165", `:=` (full_name = "phospho-CDK1 [Y15]",
                              short_name = "p_CDK1")]
panel[metal == "Er166", `:=` (full_name = "Carbonic anhydrase IX",
                              short_name = "CA9")]
panel[metal == "Er168", `:=` (short_name = "Ki67")]
panel[metal == "Er170", `:=` (full_name = "phospho-JNK [T183/Y185]",
                              short_name = "p_JNK")]
panel[metal == "Yb171", `:=` (full_name = "phospho-S6 [S235/S236]",
                              short_name = "p_S6")]
panel[metal == "Yb172", `:=` (full_name = "cleaved-Caspase 3",
                              short_name = "c_CASP3")]
panel[metal == "Yb173", `:=` (full_name = "phospho-STAT3 [Y705]",
                              short_name = "p_STAT3")]
panel[metal == "Yb174", `:=` (short_name = "c_PARP")]
panel[metal == "Lu175", `:=` (full_name = "phopsho-Rb [S807/S811]",
                              short_name = "p_Rb")]
panel[metal == "Yb176", `:=` (full_name = "DYKDDDDK tag")]
panel[metal == "Ir193", `:=` (full_name = "Iridium 193", antibody_clone = NA)]
```
...
counts_X <- counts_X[order(match(rownames(counts_X), cell_meta$cell_obj_id)), ]
...
print(identical(mcols(images)$image_name, mcols(masks)$image_name))
...
print(identical(mcols(images)$image_number, mcols(masks)$image_number))
```
