...
colData <- colData[, .(
  ...
  analysis_cat = analysis_cat,
  astir_type = astir_type,
  metacluster_combined = metacluster_combined,
  pN_merg = pN_merg,
  metacluster_tumor_combined = metacluster_tumor_combined,
  count_neighbors.B_cell = count_neighbors.B_cell,
  count_neighbors.CD4_T_cell = count_neighbors.CD4_T_cell,
  count_neighbors.CD8_T_cell = count_neighbors.CD8_T_cell,
  count_neighbors.Endothelial = count_neighbors.Endothelial,
  count_neighbors.HLA_DR = count_neighbors.HLA_DR,
  count_neighbors.Immune_low = count_neighbors.Immune_low,
  count_neighbors.Monocyte = count_neighbors.Monocyte,
  count_neighbors.Neutrophil = count_neighbors.Neutrophil,
  count_neighbors.Stromal = count_neighbors.Stromal,
  count_neighbors.tumor = count_neighbors.tumor,
  CD8Tcell_type = CD8Tcell_type,
  spatial_CD8_pheno = spatial_CD8_pheno,
  spatial_CD8_pheno_merg = spatial_CD8_pheno_merg,
  patch_B_cell = patch_B_cell,
  B_cell_score = B_cell_score,
  patch_MC8 = patch_MC8,
  patch_tumor_3 = patch_tumor_3,
  patch_tumor_8 = patch_tumor_8,
  CK5_7_score = CK5_7_score,
  CK5_7_group = CK5_7_group,
  CK5_7_group_name = CK5_7_group_name,
  BL_CD8_group = BL_CD8_group,
  BL_CD8_group_merg = BL_CD8_group_merg,
  PID_group_risk = PID_group_risk,
  pretreatment = pretreatment,
  CD8_number_category = CD8_number_category,
  CD8_number_category_merg = CD8_number_category_merg,
  GMM_Ki67 = GMM_Ki67,
  cluster_combined = cluster_combined,
  cluster_broad = cluster_broad
)]
...
c("sample_id", "ObjectNumber", "Pos_X", "Pos_Y", "area", "major_axis_length", 
"minor_axis_length", "eccentricity", "width_px", "height_px", 
"cell_id", "PID", "TMANr", "n_samples", "age", "tumor_size_cm", 
"grade", "pT", "pT_simple", "pN", "pN_simple", "pM", "pM_simple", 
"status_OS", "OS_months", "status_DFS", "DFS_months", "age_bin", 
"tissue_area", "GMM_CK", "GMM_Ecad", "n_neighbors", "cluster_category", 
"analysis_cat", "astir_type", "metacluster_combined", "pN_merg", 
"metacluster_tumor_combined", "count_neighbors.B_cell", "count_neighbors.CD4_T_cell", 
"count_neighbors.CD8_T_cell", "count_neighbors.Endothelial", 
"count_neighbors.HLA_DR", "count_neighbors.Immune_low", "count_neighbors.Monocyte", 
"count_neighbors.Neutrophil", "count_neighbors.Stromal", "count_neighbors.tumor", 
"CD8Tcell_type", "spatial_CD8_pheno", "spatial_CD8_pheno_merg", 
"patch_B_cell", "B_cell_score", "patch_MC8", "patch_tumor_3", 
"patch_tumor_8", "CK5_7_score", "CK5_7_group", "CK5_7_group_name", 
"BL_CD8_group", "BL_CD8_group_merg", "PID_group_risk", "pretreatment", 
"CD8_number_category", "CD8_number_category_merg", "GMM_Ki67", 
"cluster_combined", "cluster_broad")
