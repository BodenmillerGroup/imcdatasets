...
# Read-in the data
cells <- read.csv(file.path(workdir, "CellSubset.csv"), stringsAsFactors = FALSE)
...
# Read-in the data
image <- read.csv(file.path(workdir, "All_Image.csv"), stringsAsFactors = FALSE)
```
...
# Read-in the data
celltypes <- read.csv(file.path(workdir, "CellTypes.csv"), stringsAsFactors = FALSE)
```
...
download.file(url.channelmass, destfile = file.path(workdir, "ChannelMass.csv"))
...
file.remove(
    file.path(workdir, "All_Image.csv"),
...
# Remove image stacks
images.del <- list.files(workdir, pattern="_full_clean.tiff", full.names = TRUE)
file.remove(images.del)

# Remove masks
masks.del <- list.files(workdir, pattern="_full_mask.tiff", full.names = TRUE)
